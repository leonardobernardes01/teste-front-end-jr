...
function Topbar() {
  return (
    <div className="header__topbar">
      <ul className="header__topbar--ul">
        <li className="header__topbar--li">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
        ...
        <li className="header__topbar--li">
          ...
          <label><strong>Frete grátis</strong> acima de R$ 200</label>
        </li>
        <li className="header__topbar--li">
          <svg
            width="20"
          ...
          <label><strong>Parcela</strong> suas compras</label>
        </li>
      </ul>
    </div>
  );
